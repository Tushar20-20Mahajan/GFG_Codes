<h2><a href="https://practice.geeksforgeeks.org/problems/remainder-on-dividing-by-11--170647/0">Remainder on dividing by 11</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a big positive number <strong>x</strong> represented as string, find value of x % 11 or x mod 11. Output is expected as an integer.</span></p>
