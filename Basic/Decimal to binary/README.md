<h2><a href="https://practice.geeksforgeeks.org/problems/decimal-to-binary-1587115620/0">Decimal to binary</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a decimal number N, compute its binary equivalent.</span></p>
