<h2><a href="https://practice.geeksforgeeks.org/problems/minimum-difference-pair5444/0">Minimum difference pair</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an unsorted array, find the minimum difference between any pair in given array.</span><br>
&nbsp;</p>
